/**
 * Curated Fallback Articles Collection
 * 
 * Provides guaranteed fresh news stories across all categories if third-party
 * news providers (NewsAPI rate limit / network outage) return empty results.
 */

const FALLBACK_ARTICLES = [
  {
    title: "Global AI Computing Clusters Shift Towards Next-Gen High-Density Chips",
  ...
  {
    title: "India Premier League & Champions Trophy: Squad Rotations and Tactical Shifts",
  ...
  {
    title: "Cannes & Venice Film Festivals Celebrate Cross-Border Cinema and Independent Creators",
    description: "Groundbreaking auteur storytelling from South Asia and Latin America captures critical acclaim at major international showcase screenings.",
    url: "https://variety.com/film/cross-border-cinema-spotlight",
    imageUrl: "/assets/editorial/entertainment_1.jpg",
    sourceName: "Cinema Daily",
...
function getFallbackArticles(category = 'all', count = 12) {
